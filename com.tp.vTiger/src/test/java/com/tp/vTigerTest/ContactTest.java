...
public class ContactTest extends BaseClass {
	...
	public void createContactTest() throws IOException, Throwable {
		...
		UtilityClassObject.getTest().log(Status.INFO, "Navigated to Contacts page");
	...
	UtilityClassObject.getTest().log(Status.INFO, "Navigated to Organizations page");
		...
		UtilityClassObject.getTest().log(Status.INFO, "Contact with Org created..");
	...
	contact_name = eu.getDataFromExcelFile("Contact", 1, 2)+jLib.getRandomNumber();
		...
		newContactPage.getSave_Btn().click();
		UtilityClassObject.getTest().log(Status.INFO, "Contact with support date created..");
