...
public class LeadTest extends BaseClass{
	...
	public void createLeadTest() throws Throwable {
		...
		UtilityClassObject.getTest().log(Status.INFO, "Navigated to Lead page");
		...
		UtilityClassObject.getTest().log(Status.INFO, "Lead created");
	...
	public void createLeadWithLeadSourceAndIndustryTest() throws  Throwable {
		...
		newLeadPage.getSave_Btn().click();
		UtilityClassObject.getTest().log(Status.INFO, "Lead with Lead source and Industry is created");
